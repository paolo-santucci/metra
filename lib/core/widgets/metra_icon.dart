...
abstract final class MetraIcons {
  ...
  static const String chevronRight =
      '<path d="M9 6l6 6-6 6" $_sc/>';

  static const String chevronLeft =
      '<path d="M15 6l-6 6 6 6" $_sc/>';

  static const String chevronDown =
      '<path d="M6 9l6 6 6-6" $_sc/>';

  static const String x =
      '<path d="M18 6L6 18M6 6l12 12" $_sc/>';
  ...
  static const String plus =
      '<path d="M12 5v14M5 12h14" $_sc/>';

  static const String check =
      '<path d="M5 12l5 5 9-9" $_sc/>';

  static const String settings =
      '<circle cx="12" cy="12" r="3" $_sc/>'
  ...
  static const String wifi =
      '<path d="M5 12.55a11 11 0 0 1 14.08 0" $_sc/>'
  ...
  static const String filter =
      '<path d="M22 3H2l8 9.46V19l4 2v-8.54z" $_sc/>';

  static const String info =
      '<circle cx="12" cy="12" r="9" $_sc/>'
      '<path d="M12 8v1M12 12v4" $_sc/>';

  static const String leaf =
      '<path d="M5 19C5 12 8 5 19 5c0 11-7 14-14 14z" $_sc/>';

  static const String export_ =
      '<path d="M12 16V4M8 8l4-4 4 4" $_sc/>'
