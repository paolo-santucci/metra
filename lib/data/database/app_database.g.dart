...
class $AppSettingsTable extends AppSettings
  ...
  late final GeneratedColumn<bool> onboardingCompleted = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(false));
  static const VerificationMeta _declaredCycleLengthMeta =
      const VerificationMeta('declaredCycleLength');
  @override
  ...
  late final GeneratedColumn<DateTime> lastLogOrSymptomWriteAt =
      GeneratedColumn<DateTime>(
          ...
          type: DriftSqlType.dateTime, requiredDuringInsert: false);
  static const VerificationMeta _backupSuspendedMeta =
      const VerificationMeta('backupSuspended');
  @override
  late final GeneratedColumn<bool> backupSuspended = GeneratedColumn<bool>(
      'backup_suspended', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  VerificationContext validateIntegrity(Insertable<AppSetting> instance,
    ...
    if (data.containsKey('declared_cycle_length')) {
      context.handle(
          _declaredCycleLengthMeta,
    ...
    if (data.containsKey('backup_suspended')) {
      context.handle(
          _backupSuspendedMeta,
