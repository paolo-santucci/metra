...
part 'cycle_entry_dao.g.dart';

@DriftAccessor(tables: [CycleEntries])
class CycleEntryDao extends DatabaseAccessor<AppDatabase>
    with _$CycleEntryDaoMixin {
  ...
  Future<void> updateCycleEntry(CycleEntriesCompanion entry) =>
      (update(cycleEntries)..where((t) => t.id.equals(entry.id.value)))
          .write(entry);
